...
prove([not,not,not, H|T], S):- H\='{', H\=not, wrt([not,not,not,H], S), wrt([not,H],S), prove(T, S).
prove([not,not, H|T], S):- H\='{', H\=not, wrt([not,not,H], S), wrt([H],S), prove(T, S).
