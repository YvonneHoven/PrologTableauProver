...
prove([not,not, H,'&',not,not,not, H3|T], '+'):- H\=not, H\=not, H3\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)), '&', atm(not,atm(not,atm(not,H3)))|T], '+'), proof(atm(not,atm(not,H)), '&', atm(not,atm(not,atm(not,H3))), '+'), prove(T, '+').
...
%%%%%%%%%%%%%%%%%verschilmetBFS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%prove(AVB+)
prove([not,not,not, H,'V', not,not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'V',atm(not,atm(not,atm(not,H3)))|T], '+'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), 'V', atm(not,atm(not,atm(not,H3))), '+'), prove(T, '+').  
prove([not,not,not, H,'V', not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'V',atm(not,atm(not,H3))|T], '+'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), 'V', atm(not,atm(not,H3)), '+'), prove(T, '+'). 
prove([not,not,not, H,'V', not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'V',atm(not,H3)|T], '+'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), 'V', atm(not,H3), '+'), prove(T, '+'). 
prove([not,not,not, H,'V',H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'V',H3|T], '+'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), 'V', H3, '+'), prove(T, '+'). 
prove([not,not, H,'V', not,not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'V',atm(not,atm(not,atm(not,H3)))|T], '+'), write("  /\\"), proof(atm(not,atm(not,H)), 'V', atm(not,atm(not,atm(not,H3))), '+'), prove(T, '+').  
prove([not,not, H,'V', not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'V',atm(not,atm(not,H3))|T], '+'), write("  /\\"), proof(atm(not,atm(not,H)), 'V', atm(not,atm(not,H3)), '+'), prove(T, '+'). 
prove([not,not, H,'V', not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'V',atm(not,H3)|T], '+'), write("  /\\"), proof(atm(not,atm(not,H)), 'V', atm(not,H3), '+'), prove(T, '+'). 
prove([not,not, H,'V',H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'V',H3|T], '+'), write("  /\\"), proof(atm(not,atm(not,H)), 'V', H3, '+'), prove(T, '+'). 
prove([not, H,'V', not,not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'V',atm(not,atm(not,atm(not,H3)))|T], '+'), write("  /\\"), proof(atm(not,H), 'V', atm(not,atm(not,atm(not,H3))), '+'), prove(T, '+').  
prove([not, H,'V', not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'V',atm(not,atm(not,H3))|T], '+'), write("  /\\"), proof(atm(not,H), 'V', atm(not,atm(not,H3)), '+'), prove(T, '+'). 
prove([not, H,'V', not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'V',atm(not,H3)|T], '+'), write("  /\\"), proof(atm(not,H), 'V', atm(not,H3), '+'), prove(T, '+'). 
prove([not, H,'V',H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'V',H3|T], '+'), write("  /\\"), proof(atm(not,H), 'V', H3, '+'), prove(T, '+'). 
prove([H,'V', not,not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'V',atm(not,atm(not,atm(not,H3)))|T], '+'), write("  /\\"), proof(H, 'V', atm(not,atm(not,atm(not,H3))), '+'), prove(T, '+'). 
prove([H,'V', not,not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'V',atm(not,atm(not,H3))|T], '+'), write("  /\\"), proof(H, 'V', atm(not,atm(not,H3)), '+'), prove(T, '+'). 
prove([H,'V', not, H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'V',atm(not,H3)|T], '+'), write("  /\\"), proof(H, 'V', atm(not,H3), '+'), prove(T, '+'). 
prove([H,'V',H3|T], '+'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'V',H3|T], '+'), write("  /\\"), proof(H, 'V', H3, '+'), prove(T, '+').
%%prove(AVB+)
...
%%prove(A&B-)
prove([not,not,not, H,'&', not,not,not, H3|T], '-'):-  H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'&',atm(not,atm(not,atm(not,H3)))|T], '-'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), '&', atm(not,atm(not,atm(not,H3))), '-'), prove(T, '-').   
prove([not,not,not, H,'&', not,not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'&',atm(not,atm(not,H3))|T], '-'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), '&', atm(not,atm(not,H3)), '-'), prove(T, '-').   
prove([not,not,not, H,'&', not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'&',atm(not,H3)|T], '-'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), '&', atm(not,H3), '-'), prove(T, '-').  
prove([not,not,not, H,'&',H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,atm(not,H))),'&',H3|T], '-'), write("  /\\"), proof(atm(not,atm(not,atm(not,H))), '&', H3, '-'), prove(T, '-'). 
prove([not,not, H,'&', not,not,not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'&',atm(not,atm(not,atm(not,H3)))|T], '-'), write("  /\\"), proof(atm(not,atm(not,H)), '&', atm(not,atm(not,atm(not,H3))), '-'), prove(T, '-').   
prove([not,not, H,'&', not,not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'&',atm(not,atm(not,H3))|T], '-'), write("  /\\"), proof(atm(not,atm(not,H)), '&', atm(not,atm(not,H3)), '-'), prove(T, '-').   
prove([not,not, H,'&', not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'&',atm(not,H3)|T], '-'), write("  /\\"), proof(atm(not,atm(not,H)), '&', atm(not,H3), '-'), prove(T, '-').  
prove([not,not, H,'&',H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,atm(not,H)),'&',H3|T], '-'), write("  /\\"), proof(atm(not,atm(not,H)), '&', H3, '-'), prove(T, '-'). 
prove([not, H,'&', not,not,not, H3|T], '-'):-  H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'&',atm(not,atm(not,atm(not,H3)))|T], '-'), write("  /\\"), proof(atm(not,H), '&', atm(not,atm(not,atm(not,H3))), '-'), prove(T, '-').   
prove([not, H,'&', not,not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'&',atm(not,atm(not,H3))|T], '-'), write("  /\\"), proof(atm(not,H), '&', atm(not,atm(not,H3)), '-'), prove(T, '-').   
prove([not, H,'&', not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'&',atm(not,H3)|T], '-'), write("  /\\"), proof(atm(not,H), '&', atm(not,H3), '-'), prove(T, '-').  
prove([not, H,'&',H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([atm(not,H),'&',H3|T], '-'), write("  /\\"), proof(atm(not,H), '&', H3, '-'), prove(T, '-'). 
prove([H,'&', not,not,not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'&',atm(not,atm(not,atm(not,H3)))|T], '-'), write("  /\\"), proof(H, '&', atm(not,atm(not,atm(not,H3))), '-'), prove(T, '-').   
prove([H,'&', not,not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'&',atm(not,atm(not,H3))|T], '-'), write("  /\\"), proof(H, '&', atm(not,atm(not,H3)), '-'), prove(T, '-').  
prove([H,'&', not, H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'&',atm(not,H3)|T], '-'), write("  /\\"), proof(H, '&', atm(not,H3), '-'), prove(T, '-'). 
prove([H,'&',H3|T], '-'):- H\=not, H3\=not, H\=atm(not,_), H3\=atm(not,_), wrt([H,'&',H3|T], '-'), write("  /\\"), proof(H, '&', H3, '-'), prove(T, '-').
%%prove(A&B-)
