...
%%prove(AVB+)
prove([H,'V',H3|T], '+'):- H3\='{', H\=not, H3\=not, T\=['&'|_], T\=['V'|_],  wrt([H,'V',H3|T], '+'), assert(toprove([H, 'V', H3], '+')), prove(T, '+').
%%prove(A&B-)
prove([H,'&',H3|T], '-'):- H3\='{', H\=not, H3\=not, T\=['&'|_], T\=['V'|_],  wrt([H,'&',H3|T], '-'), assert(toprove([H, '&', H3], '-')), prove(T, '-').
%%prove(AVB-)
